...
(function () {
     ...
     * @type {Object}
     */
    enchant.nineleap = { assets: ['http://yuyake0084.sakura.ne.jp/wp/wp-content/themes/theme-yuyakezora/game/shooting/images/start.png', 'http://yuyake0084.sakura.ne.jp/wp/wp-content/themes/theme-yuyakezora/game/shooting/images/end.png'] };
    ...
    enchant.nineleap.Core = enchant.Class.create(enchant.Core, {
        ...
        initialize: function initialize(width, height) {
            ...
            this.addEventListener('load', function () {
                ...
                this.startScene.image = this.assets['http://yuyake0084.sakura.ne.jp/wp/wp-content/themes/theme-yuyakezora/game/shooting/images/start.png'];
                ...
                this.endScene.image = this.assets['http://yuyake0084.sakura.ne.jp/wp/wp-content/themes/theme-yuyakezora/game/shooting/images/end.png'];
        ...
        _requestPreload: function _requestPreload() {
            var o = {};
            var loaded = 0,
                len = 0,
            ...
            this._assets.concat(this._twitterAssets || []).concat(this._netpriceData || []).concat(this._memoryAssets || []).reverse().forEach(function (asset) {
                var src, name;
        ...
        end: function end(score, result, img) {
            if (img !== undefined) {
            ...
            if (location.hostname === 'r.jsgames.jp') {
                var submit = function submit() {
                    ...
                    location.replace(['http://9leap.net/games/', id, '/result', '?score=', encodeURIComponent(score), '&result=', encodeURIComponent(result)].join(''));
                };
