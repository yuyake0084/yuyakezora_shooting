...
enchant.extendMap.ExMap = enchant.Class.create(enchant.Map, {
    ...
    isOwn: function isOwn(index, x, y, own) {
        var data = this._typeData[index][y][x];
        if (data == own || data == -1 || data > 7 || typeof this._types != 'undefined' && this._types[data].parentNum == this._types[own].baseNum) {
            return true;
        } else {
            return false;
        }
    },
    searchPattern: function searchPattern(index, x, y) {
        var patternTable = {
    ...
    match: function match(ind1, ind2) {
        var i = 0;
        while (i < 1024) {
    ...
    loadTypeData: function loadTypeData(data) {
    ...
    image: {
        ...
        set: function set(image) {
            ...
            var Type = function Type(image, left, top, tileWidth, tileHeight) {
                this.baseType = [];
                this.parentType = [];
            ...
            var extract = function extract(left, top, sx, sy) {
                var params = [[0, 16, 48, 8, 16, 0, 48, 8], [0, 56, 48, 8, 16, 8, 48, 8], [0, 16, 8, 48, 48, 16, 8, 48], [40, 16, 8, 48, 56, 16, 8, 48], [0, 16, 48, 48, 0, 16, 48, 48], [40, 8, 8, 8, 8, 24, 8, 8], [40, 0, 8, 8, 8, 48, 8, 8], [32, 8, 8, 8, 32, 24, 8, 8], [32, 0, 8, 8, 32, 48, 8, 8], [40, 0, 8, 8, 8, 32, 8, 8], [40, 8, 8, 8, 8, 40, 8, 8], [32, 0, 8, 8, 32, 32, 8, 8], [32, 8, 8, 8, 32, 40, 8, 8], [32, 8, 8, 8, 16, 24, 8, 8], [40, 8, 8, 8, 24, 24, 8, 8], [40, 0, 8, 8, 24, 48, 8, 8], [32, 0, 8, 8, 16, 48, 8, 8], [32, 0, 16, 16, 112, 16, 16, 16], [32, 0, 16, 16, 112, 32, 16, 16], [32, 0, 16, 16, 112, 48, 16, 16], [32, 0, 16, 16, 128, 16, 16, 16], [32, 0, 16, 16, 128, 48, 16, 16], [32, 0, 16, 16, 144, 16, 16, 16], [32, 0, 16, 16, 144, 32, 16, 16], [32, 0, 16, 16, 144, 48, 16, 16], [24, 32, 8, 8, 120, 48, 8, 8], [24, 40, 8, 8, 120, 24, 8, 8], [16, 32, 8, 8, 144, 48, 8, 8], [16, 40, 8, 8, 144, 24, 8, 8], [16, 40, 16, 8, 128, 24, 16, 8], [16, 32, 16, 8, 128, 48, 16, 8], [24, 32, 8, 16, 120, 32, 8, 16], [16, 32, 8, 16, 144, 32, 8, 16], [0, 16, 8, 8, 128, 32, 8, 8], [40, 16, 8, 8, 136, 32, 8, 8], [0, 56, 8, 8, 128, 40, 8, 8], [40, 56, 8, 8, 136, 40, 8, 8], [16, 32, 16, 16, 64, 0, 16, 16], [40, 0, 8, 8, 72, 0, 8, 8], [16, 32, 16, 16, 80, 0, 16, 16], [32, 0, 8, 8, 80, 0, 8, 8], [16, 32, 16, 16, 96, 0, 16, 16], [40, 8, 8, 8, 104, 8, 8, 8], [16, 32, 16, 16, 112, 0, 16, 16], [32, 8, 8, 8, 112, 8, 8, 8], [16, 32, 16, 16, 128, 0, 16, 16], [40, 0, 8, 8, 136, 0, 8, 8], [32, 8, 8, 8, 128, 8, 8, 8], [16, 32, 16, 16, 144, 0, 16, 16], [32, 0, 8, 8, 144, 0, 8, 8], [40, 8, 8, 8, 152, 8, 8, 8], [32, 32, 16, 16, 160, 0, 16, 16], [32, 32, 16, 16, 160, 16, 16, 16], [32, 8, 8, 8, 160, 8, 8, 8], [32, 0, 8, 8, 160, 16, 8, 8], [0, 32, 16, 16, 176, 0, 16, 16], [0, 32, 16, 16, 176, 16, 16, 16], [40, 8, 8, 8, 184, 8, 8, 8], [40, 0, 8, 8, 184, 16, 8, 8], [8, 48, 16, 16, 160, 32, 16, 16], [8, 48, 16, 16, 176, 32, 16, 16], [40, 0, 8, 8, 168, 32, 8, 8], [32, 0, 8, 8, 176, 32, 8, 8], [8, 16, 16, 16, 160, 48, 16, 16], [8, 16, 16, 16, 176, 48, 16, 16], [40, 8, 8, 8, 168, 56, 8, 8], [32, 8, 8, 8, 176, 56, 8, 8], [0, 0, 16, 16, 0, 0, 16, 16], [0, 16, 48, 48, 64, 16, 48, 48], [32, 0, 16, 16, 16, 32, 16, 16]];
